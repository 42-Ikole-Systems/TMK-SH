...
public:
public:
	virtual MaterializedEnvironment getEnvironmentVariables();
	...
	*/
	virtual void addEnvironmentVariable(const string &variable);

	/*!
	* @brief
	* @param name
	*/
	virtual void removeEnvironmentVariable(const string &name);
	...
	* @return
	*/
	virtual const char *get(const string &name);
	/*!
	* @brief
	* @return
	*/
